...
def get_lists_intersection(_lst1, _lst2):
    lst1 = sorted(list(set(_lst1)))
    lst2 = sorted(list(set(_lst2)))
    intersection = set(lst1).intersection(lst2)
    return intersection


def get_nof_common_elements(l1, l2):
    nof_common_elements = len(get_lists_intersection(l1, l2))
    return nof_common_elements
